...
ALTER TABLE retail.orders DROP CONSTRAINT orders_customer_id_fkey;
...
FOREIGN KEY (customer_id) REFERENCES retail.customers (customer_id) NOT VALID;
...
LEFT JOIN retail.customers c USING (customer_id)
